...
res.end('<h1>สวัสดีค่ะ! นี่คือ Web Server ของ นางสาววรินทร พนาวัน 69319010024</h1><p>เครื่องแม่ข่ายทํางานปกติบนระบบ Railway แล้วครับผม!</p>');
});

// 4. สั่งใหเซิรฟเวอรเริ่มตนเปดรับฟงการเชื่อมตอตาม Port ที่กําหนดไว
server.listen(port, () => {
console.log(`Server is running! เครื่องแม่ข่ายเป็นทํางานแล้วที่ช่องทาง: ${port}`);
});
